...
func main() {
	...
	var p2 = Person{FirstName: "Kiarash", LastName: "Soleimanzadeh", Age: 32}
...
$ go run main.go
Person 1: {  0}
Person 2: {Kiarash Soleimanzadeh 32}
```
...
```bash
$ go run main.go
Person &{Kiarash Soleimanzadeh 32}
```
