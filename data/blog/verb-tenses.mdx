...
<code class="mermaid bg-white flex justify-center">
mindmap
    Present
        Simple[Simple]
        ...
        PerfectContinuous["Perfect Continuous"]
            19)"`Present perfect: completion/result/experience/repetition,<br/>Present perfect continuous (except state verbs): duration/continuation`"(
