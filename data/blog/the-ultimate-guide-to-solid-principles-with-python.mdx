...
> _Subtype Requirement: Let `φ(x)` be a property provable about objects `x` of type `T`. Then `φ(y)` should be true for objects `y` of type `S` where `S` is a subtype of `T`._
>
...
<figure class="max-w-screen-md mx-auto text-center">
    ...
    <blockquote>
        <p class="text-2xl italic font-medium text-gray-900 dark:text-white">"A: High level modules should not depend upon low level Modules. Both should depend upon abstractions."</p>
        <p class="text-2xl italic font-medium text-gray-900 dark:text-white">"B: Abstractions should not depend upon details. Details should depend upon abstractions."</p>
    </blockquote>
    <figcaption class="flex items-center justify-center mt-6 space-x-3 rtl:space-x-reverse">
        <div class="flex items-center divide-x-2 rtl:divide-x-reverse divide-gray-500 dark:divide-gray-700">
            <cite class="pe-3 font-medium text-gray-900 dark:text-white">The Dependency Inversion Principle</cite>
            <cite class="ps-3 text-sm text-gray-500 dark:text-gray-400">Robert C. Martin</cite>
        </div>
    </figcaption>
</figure>
