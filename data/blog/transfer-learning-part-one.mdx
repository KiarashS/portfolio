...
images: ['https://file.kiarashs.ir/PicGo/transfer%20learning%201.png']
authors: ['default']
---
...
<div class="p-4 mb-4 text-sm text-green-800 border border-green-300 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400" role="alert">
  <p class="my-0">Nowadays, using transfer learning in academia and industry is a state-of-the-art technique. Keep your head up and go ahead!</p>
</div>
...
<div class="p-4 mb-4 text-sm text-blue-800 border border-blue-300 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400" role="alert">
    <p class="my-0">It is obvious that the accuracy of a model may be reduced in the target system, and we should try to maximize the accuracy using transfer learning techniques.</p>
</div>

<div class="p-4 mb-4 text-sm text-blue-800 border border-blue-300 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400" role="alert">
    <p class="my-0">Domains of source and target systems should NOT be completely separated.</p>
</div>
