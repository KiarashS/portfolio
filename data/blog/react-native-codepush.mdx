...
<i>
  ...
  [here](https://kiarashs.ir/blog/continuous-integration-appcenter-react-native)
</i>
...
```bash
appcenter codepush release-react -a KiarashS/CodePushDemo -d Staging
```
...
```json
"scripts": {
  "codepush:ios": "appcenter codepush release-react -a KiarashS/CodePushDemo -d Staging",
  "codepush:android": "appcenter codepush release-react -a KiarashS/CodePushDemo-Android -d Staging"
}
```
...
If you're interested in CI/CD with AppCenter, checkout my other [article](https://kiarashs.ir/blog/continuous-integration-appcenter-react-native) about it.
...
<i>
  ...
  [Twitter](https://twitter.com/ItIsKiarash) or
