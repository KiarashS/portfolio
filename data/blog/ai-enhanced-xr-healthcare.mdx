...
<div class="flex justify-center items-center">
  <figure>
    <img src="/static/blogs/content-images/ai-enhanced-xr-healthcare/fig1-two-track-architecture.svg" alt="Two-track architecture of an AI-enhanced XR clinical system" />
    <figcaption class="text-center">Figure 1. The fast track is a hard real-time deadline. The slow track is not, provided its output is anchored to a pose the fast track already knows.</figcaption>
  </figure>
</div>
...
<div class="flex justify-center items-center">
  <figure>
    <img src="/static/blogs/content-images/ai-enhanced-xr-healthcare/fig2-segmentation-prompting.svg" alt="Prompt-driven segmentation, 2D versus volumetric" />
    <figcaption class="text-center">Figure 2. Fewer prompts is the headline. Where those prompts have to be placed is the part that concerns interface designers.</figcaption>
  </figure>
</div>
...
<div class="flex justify-center items-center">
  <figure>
    <img src="/static/blogs/content-images/ai-enhanced-xr-healthcare/fig3-social-prominence.svg" alt="The social prominence design space" />
    <figcaption class="text-center">Figure 3. Three points in a two-dimensional design space, and what happened at each.</figcaption>
  </figure>
</div>
...
<div class="flex justify-center items-center">
  <figure>
    <img src="/static/blogs/content-images/ai-enhanced-xr-healthcare/fig4-reliance-matrix.svg" alt="The reliance matrix and its group-level gap" />
    <figcaption class="text-center">Figure 4. Manipulating whether the agent is correct is what makes the distinction measurable at all.</figcaption>
  </figure>
</div>
...
<div class="flex justify-center items-center">
  <figure>
    <img src="/static/blogs/content-images/ai-enhanced-xr-healthcare/fig5-evidence-map.svg" alt="Evidence maturity map" />
    <figcaption class="text-center">Figure 5. Sorted by how much weight each claim will bear.</figcaption>
  </figure>
</div>
