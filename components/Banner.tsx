  ...
  return (
    <div className='fade-in banner flex flex-1 flex-col justify-center px-6 py-10 dark:text-white lg:px-10'>
      ...
      <p className='font-light mb-2 lg:text-xl'>
        ...
        <Link className='ml-2 mr-2 font-normal text-black inline-grid ml-0' href='/blog'>
          <RoughNotation
            show
            type='highlight'
            animationDelay={250}
      ...
      <p className='font-light mb-2 lg:text-xl'>
        Read more
        <Link className='ml-2 mr-2 font-normal text-black inline-grid ml-0' href='https://profile.kiarashs.ir'>
          <RoughNotation
            show
            type='highlight'
            animationDelay={250}
        ...
        ,
        <Link className='ml-2 mr-2 font-normal text-black inline-grid ml-0' href='/about'>
          <RoughNotation
            show
            type='highlight'
            animationDelay={250}
        ...
        or
        <Link className='ml-2 font-normal text-black inline-grid ml-0' href='/contact'>
          <RoughNotation
            show
            type='highlight'
            animationDelay={250}
      ...
      <p className='font-light lg:text-xl'>
        Download
        <Link className='ml-2 mr-2 font-normal text-black inline-grid ml-0' href='https://drive.google.com/uc?export=download&id=16tzJJoNP3vkURX1Oj5wmRCTIemtQ7Ksl'>
          <RoughNotation
            show
            type='highlight'
            animationDelay={250}
