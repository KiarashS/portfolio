      ...
      <div className='fade-in divide-y-2 divide-gray-100 dark:divide-gray-800'>
        ...
        <div className='container py-12 px-6'>
          ...
          <ul className="list-disc">
            <li className='mb-2'><a href='https://go.kiarashs.ir/regex' target='_blank' rel='noreferrer'>Regular Expression (regex or regexp) for data scientists</a></li>
            <li className='mb-2'><a href='https://go.kiarashs.ir/cc' target='_blank' rel='noreferrer'>Clean Code</a></li>
          </ul>
            {/* <span
