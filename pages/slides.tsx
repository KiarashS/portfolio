      ...
      <div className='fade-in divide-y-2 divide-gray-100 dark:divide-gray-800'>
        ...
        <div className='container py-12 px-6'>
          ...
          <div className='p-2 bg-indigo-800 items-center text-indigo-100 leading-none lg:rounded-full flex lg:inline-flex' role='alert'>
            ...
            <span className='font-semibold mr-2 text-left flex-auto'>Please check out <a href='https://directory.kiarashs.ir/' target='_blank' rel='noreferrer' className='font-medium text-orange-600 dark:text-blue-500 hover:text-blue-800'>my directory</a> for awesome links and files also!</span>
          </div>
      </div>
    </>
  );
